...
{
    /// <inheritdoc />
    public partial class UpdateModuleSectionSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErpModuleId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScribeLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InteractiveSteps = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UploadedContents_AspNetUsers_UploadedById",
                        column: x => x.UploadedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UploadedContents_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UploadedContents_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UploadedContents_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAnswers_AssessmentAttempts_AssessmentAttemptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_ModuleId_Order",
                table: "Sections",
                columns: new[] { "ModuleId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_UploadedContents_LessonId",
                table: "UploadedContents",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadedContents_ModuleId",
                table: "UploadedContents",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadedContents_SectionId",
                table: "UploadedContents",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadedContents_UploadedById",
                table: "UploadedContents",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_AssessmentAttemptId",
                table: "UserAnswers",
